  ...
  <main class="auth-page auth-cover-page">
    ...
    <section class="auth-form-panel">
      <div class="auth-form-wrap">
        ...
        <form><label class="form-label">Full name</label><input class="form-control mb-3" placeholder="Sara Ahmed"><label class="form-label">Email address</label><input class="form-control mb-3" type="email" placeholder="name@example.com"><label class="form-label">Password</label><input class="form-control mb-2" type="password" placeholder="Password"><label class="auth-terms"><input type="checkbox" checked> I agree to privacy policy and terms</label><button class="btn btn-primary w-100">Create Account</button></form>
