...
<header class="topbar">
    ...
    <div class="horizontal-dropdown">
        ...
        <div class="dropdown-menu soft-dropdown horizontal-menu">
          <a class="dropdown-item " href="pricing.html"><i class="bi bi-tags"></i>Pricing</a><a class="dropdown-item " href="profile.html"><i class="bi bi-person-circle"></i>Profile</a><a class="dropdown-item {{ request()->routeIs('settings') ? 'active' : '' }}" href="{{ route('settings') }}"><i class="bi bi-gear"></i>Settings</a><a class="dropdown-item {{ request()->routeIs('team') ? 'active' : '' }}" href="{{ route('team') }}"><i class="bi bi-person-workspace"></i>Team</a><a class="dropdown-item " href="notifications.html"><i class="bi bi-bell"></i>Notifications</a>@can('view_finance')<a class="dropdown-item {{ request()->routeIs('income.index') ? 'active' : '' }}" href="{{ route('income.index') }}"><i class="bi bi-cash-stack"></i>Income</a><a class="dropdown-item {{ request()->routeIs('profit.index') ? 'active' : '' }}" href="{{ route('profit.index') }}"><i class="bi bi-graph-up-arrow"></i>Profit Analyzer</a><a class="dropdown-item {{ request()->routeIs(['reports', 'reports.generate']) ? 'active' : '' }}" href="{{ route('reports') }}"><i class="bi bi-clipboard-data"></i>Reports</a>@endcan<a class="dropdown-item " href="faq.html"><i class="bi bi-question-circle"></i>FAQ</a>
