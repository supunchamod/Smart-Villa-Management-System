...
@section('title', 'Invoice List | '.$globalSettings->villa_name.' Admin Dashboard')
        ...
        <div class="page-title">
          <nav class="page-breadcrumb" aria-label="breadcrumb">
            <ol>
              ...
              <li aria-current="page"><h1>Invoice List</h1></li>
            </ol>
          </nav>
          <div class="page-actions"><button class="btn btn-light" data-export-page><i class="bi bi-download"></i> Export</button><button class="btn btn-primary" data-create-open data-create-type="invoice-list" data-create-label="Create Invoice"><i class="bi bi-plus-lg"></i> Create Invoice</button></div>
        </div>
