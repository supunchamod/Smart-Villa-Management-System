  ...
  <div class="row g-4 mt-1">
    ...
    <div class="col-xl-3">
      <div class="panel event-agenda h-100 d-flex flex-column justify-content-between">
        <div>
          <div class="panel-head"><div><h2>Upcoming</h2><p>Next scheduled items</p></div></div>
          <div class="vc-agenda-list">
            <div class="d-flex align-items-center p-3 mb-3 rounded shadow-xs vc-agenda-card">
              <div class="text-center me-3 px-2 py-1 rounded vc-agenda-date">
                <span class="d-block fw-bold vc-agenda-date-num">08</span>
                <span class="text-uppercase vc-agenda-date-month">May</span>
              </div>
              <div class="vc-agenda-content">
                <strong class="vc-agenda-title">Design Sync</strong>
                <small class="vc-agenda-meta">09:00 &middot; Product team</small>
              </div>
            </div>
            <div class="d-flex align-items-center p-3 mb-3 rounded shadow-xs vc-agenda-card">
              <div class="text-center me-3 px-2 py-1 rounded vc-agenda-date">
                <span class="d-block fw-bold vc-agenda-date-num">12</span>
                <span class="text-uppercase vc-agenda-date-month">May</span>
              </div>
              <div class="vc-agenda-content">
                <strong class="vc-agenda-title">Invoice Review</strong>
                <small class="vc-agenda-meta">11:30 &middot; Finance</small>
              </div>
            </div>
            <div class="d-flex align-items-center p-3 mb-3 rounded shadow-xs vc-agenda-card">
              <div class="text-center me-3 px-2 py-1 rounded vc-agenda-date">
                <span class="d-block fw-bold vc-agenda-date-num">16</span>
                <span class="text-uppercase vc-agenda-date-month">May</span>
              </div>
              <div class="vc-agenda-content">
                <strong class="vc-agenda-title">Sprint Demo</strong>
                <small class="vc-agenda-meta">14:00 &middot; Engineering</small>
              </div>
            </div>
            <div class="d-flex align-items-center p-3 mb-0 rounded shadow-xs vc-agenda-card">
              <div class="text-center me-3 px-2 py-1 rounded vc-agenda-date">
                <span class="d-block fw-bold vc-agenda-date-num">28</span>
                <span class="text-uppercase vc-agenda-date-month">May</span>
              </div>
              <div class="vc-agenda-content">
                <strong class="vc-agenda-title">Board Update</strong>
                <small class="vc-agenda-meta">16:30 &middot; Leadership</small>
              </div>
            </div>
          </div>
        </div>
