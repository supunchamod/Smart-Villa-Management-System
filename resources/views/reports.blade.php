...
@section('title', 'Reports | Dashora Admin Dashboard')
...
@section('content')
        <div class="page-title">
          ...
          <div class="page-actions"><button class="btn btn-light" data-export-page><i class="bi bi-download"></i> Export</button><button class="btn btn-primary" data-create-open data-create-type="reports" data-create-label="Create Report"><i class="bi bi-plus-lg"></i> Create Report</button></div>
        </div>
