...
@section('title', 'Customers | '.$globalSettings->villa_name.' Admin Dashboard')
        ...
        <div class="page-title">
          <nav class="page-breadcrumb" aria-label="breadcrumb">
            <ol>
              ...
              <li aria-current="page"><h1>Customers</h1></li>
            </ol>
          </nav>
          <div class="page-actions"><button class="btn btn-light" data-export-page><i class="bi bi-download"></i> Export</button><button class="btn btn-primary" data-create-open data-create-type="customers" data-create-label="Add Customer"><i class="bi bi-plus-lg"></i> Add Customer</button></div>
        </div>
